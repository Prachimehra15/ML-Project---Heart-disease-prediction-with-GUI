...
def takeInput():
    ...
    if final_Result[0] == 1:
        ...
        label3 = tkinter.Label(substituteWindow, text = "DELHI - Dr. PSG Heart & vascular clinic", font=('Times', -15))
        label3.grid(row=3, column = 2)
        label4 = tkinter.Label(substituteWindow, text = "MUMBAI- Four Chambers Heart Clinic", font=('Times', -15))
        label4.grid(row=4, column = 2)
        label4 = tkinter.Label(substituteWindow, text = " CHENNAI- Dr.Anita Mokashi  hospital", font=('Times', -15))
...
chestPainFrame = tkinter.LabelFrame(mainWindow, text="CP ")
...
rbpFrame = tkinter.LabelFrame(mainWindow, text="RBP ")
...
thalachFrame = tkinter.LabelFrame(mainWindow, text="thalach")
...
oldpeakFrame = tkinter.LabelFrame(mainWindow, text="Old Peak(0-5)")
...
slopeFrame = tkinter.LabelFrame(mainWindow, text="Slope")
...
thalFrame = tkinter.LabelFrame(mainWindow, text=" THAL(1-7)")
...
analyseButton = tkinter.Button(mainWindow, text=" PREDICT", font=('Impact', -15), bg = 'red', command=takeInput)
